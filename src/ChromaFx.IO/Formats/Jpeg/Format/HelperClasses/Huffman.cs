...
using ChromaFx.IO.Formats.Jpeg.Format.HelperClasses.Exceptions;

namespace ChromaFx.IO.Formats.Jpeg.Format.HelperClasses;
...
public class Huffman
{
    ...
    /// <returns></returns>
    /// <exception cref="Exception">uninitialized Huffman table
    /// or
