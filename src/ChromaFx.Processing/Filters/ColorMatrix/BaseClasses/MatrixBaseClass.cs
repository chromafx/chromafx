...
public abstract class MatrixBaseClass : IFilter
{
    ...
    )
    {
        ...
        Span<float> r = stackalloc float[simdWidth];
        Span<float> g = stackalloc float[simdWidth];
        Span<float> b = stackalloc float[simdWidth];
        Span<float> a = stackalloc float[simdWidth];
        int i = rowStart;
