...
|------------------------|-----------------------------------------------------------------------------|----------------------------------------------------------|
| `ChromaFx`             | Main package. Modern, high-performance image processing for .NET 8 and 10.  | [ChromaFx](https://www.nuget.org/packages/ChromaFx/)     |
...
- Use `ChromaFx` for new projects targeting .NET 8 or .NET 10.
