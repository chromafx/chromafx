...
public class ChunkTypes
{
    ...
    public void Create()
    {
        var testObject = new ChromaFx.Formats.Png.Format.Helpers.ChunkTypes("ASDF");
    ...
    {
        var testObject1 = new ChromaFx.Formats.Png.Format.Helpers.ChunkTypes("ASDF");
        var testObject2 = new ChromaFx.Formats.Png.Format.Helpers.ChunkTypes("ASDF");
    ...
    {
        var testObject1 = new ChromaFx.Formats.Png.Format.Helpers.ChunkTypes("ASDF");
        var testObject2 = new ChromaFx.Formats.Png.Format.Helpers.ChunkTypes("ASDF2");
